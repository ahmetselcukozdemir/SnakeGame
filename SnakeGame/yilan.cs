...
namespace Yilan
{
    class yilan
    {
        ...
        Yon yonumuz;
        Size buyukluk;
        public yilan(Size oyun_buyukluk)
        {
            buyukluk = oyun_buyukluk;
        ...
        public void İlerle(Yon yon)
        {
            ...
            else
            {
                ...
                yilan_parca[0] = new yilan_parcalari((yilan_parca[0].x_ + yon._x) % buyukluk.Width, (yilan_parca[0].y_ + yon._y) % buyukluk.Height);
                if (yilan_parca[0].x_ < 0) 
                {
                 yilan_parca[0].x_+=buyukluk.Width;
                }
                if (yilan_parca[0].y_ < 0)
                {
                    yilan_parca[0].y_ += buyukluk.Height;
                }
            }
        }
        public void Buyu()
